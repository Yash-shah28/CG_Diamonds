...
function SellerEmailVerification() {

    let [code, setCode] = useState(["", "", "", "", "", ""]);
    let inputRef = useRef([]);
    const navigate = useNavigate();

    const {sellerAuth, verifyEmail} = useContext(SellerContext);
                ...
                <div className=" pt-25 flex items-center justify-center min-h-screen bg-gray-100">
                    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md mx-4">
                        ...
                        <form onSubmit={handlesubmit} noValidate>
                            ...
                            >
                               {sellerAuth.isLoading ? <Loader className='animate-spin mx-auto' size={24}/>: "Verify Email"}
                            </button>
                        </form>
